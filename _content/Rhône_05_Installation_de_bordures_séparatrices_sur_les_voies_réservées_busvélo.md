# **Installation de bordures séparatrices sur les voies réservées bus/vélo**
...
·       Incertitude : Élevée, due au manque de données spécifiques sur l'impact de cette mesure dans le contexte local.

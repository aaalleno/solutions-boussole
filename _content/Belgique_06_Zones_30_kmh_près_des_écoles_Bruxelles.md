# **Zones 30 km/h près des écoles (Bruxelles)**

**Source** : [Bruxelles Mobilité 2023](https://mobilite-mobiliteit.brussels/fr)

## 1. **PRÉSENTATION DE LA MESURE**

* **Nom** : Zones 30 km/h avec ralentisseurs.  
* **Description** : 120 écoles équipées de ralentisseurs et marquage au sol. Cible enfants/parents.  
* **Exemples inspirants** : Paris (-31% de mortalité).  
* **Accidents ciblés** :  
  * **Facteurs** : Vitesse (\>50 km/h dans 30% des cas).  
  * **Répartition** : 40 blessés graves/an.  
  * **Profil** : Enfants 6-12 ans.  
  * **Zones** : Bruxelles-Ville, Schaerbeek.


## 2. **BILAN HUMAIN ESTIMÉ**

* **Morts évités** : **2/an** → **2 × 70 ans** \= **140 années**.  
* **Blessés évités** :  
  * **Sévères** : 5 → 5 × 70 × 0,8 \= **280 années**.  
  * **Modérés** : 10 → 10 × 70 × 0,3 \= **210 années**.  
  * **Légers** : 25 → 25 × 70 × 0,1 \= **175 années**.  
* **Co-victimes** : 60 → **60 × 2** \= **120 années**.  
* **Total net** : **925 années**.  
* **Coût-efficacité** : **925 / 0,08 M€** \= **11 562 années/€M**.  
* **Prévisibilité** : Très élevée.

## 3. **MISE EN ŒUVRE**

* **Coût** : 80k€/an (signalétique \+ ralentisseurs).  
* **Délai** : 1-3 mois/école.

## 4. **ANNEXES TECHNIQUES**

* **Probabilité accidents** : 0,05 accident/école/an → 6 évités/an.  
* **Fiabilité** : Très élevée. **Incertitude** : ±5%.  
* **Acceptabilité** : 78% des parents favorables.

### **CLASSIFICATION DES MESURES**

**Objectif **: Réduire vitessse 

**Usagers **: Automobilistes

**Pratiques **: Vitesse

**Accident **: Collision automobiliste/Piétons (enfants)

**Type de voie **: Communale

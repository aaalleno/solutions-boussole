# **Marquage coloré aux intersections (Saint-Gilles)**

**Source** : [Brussels Times 2025](https://www.brusselstimes.com/1483161/belgian-solution-saint-gilles-tackles-road-safety-with-colourful-twist)

## 1. **PRÉSENTATION DE LA MESURE**

* **Nom** : Peinture biodégradable rouge/verte aux carrefours.  
* **Description** : Réduit la vitesse de 25% par effet d’alerte visuelle. Cible piétons/seniors.  
* **Exemples inspirants** : Londres (-30% de collisions).  
* **Accidents ciblés** :  
  * **Facteurs** : Visibilité réduite (40%).  
  * **Répartition** : 80 blessés graves/an à Bruxelles.


## 2. **BILAN HUMAIN ESTIMÉ**

* **Morts évités** : **1/an** → **1 × 70** \= **70 années**.  
* **Blessés évités** :  
  * **Sévères** : 5 → 5 × 70 × 0,8 \= **280 années**.  
  * **Modérés** : 15 → 15 × 70 × 0,3 \= **315 années**.  
  * **Légers** : 30 → 30 × 70 × 0,1 \= **210 années**.  
* **Total net** : **875 années**.  
* **Coût-efficacité** : **875 / 0,1 M€** \= **8 750 années/€M**.

## 3. **MISE EN ŒUVRE**

* **Coût** : 100k€/an (20 intersections à 5k€).  
* **Délai** : 1 mois/intersection.

## 4. **ANNEXES TECHNIQUES**

* **Sources** : Bruxelles Mobilité, études Londres.  
* **Acceptabilité** : 92% des piétons favorables.

### **CLASSIFICATION DES MESURES**

**Objectif **: Améliorer la visibilité

**Usagers **: Automobilistes, cyclistes et piétons

**Pratiques **: Inattention \+ vitesse

**Accident **: Collision automobilistes/piétons, automobilistes/cyclistes et cyclistes/piétons

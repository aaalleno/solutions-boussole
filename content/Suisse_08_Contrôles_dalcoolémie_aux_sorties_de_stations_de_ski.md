...
* **Description** : Cette mesure renforce les contrôles d’alcoolémie sur les routes quittant les stations de ski suisses (ex. : Verbier, Zermatt) en hiver, ciblant les conducteurs après les après-ski pour réduire les accidents liés à l’alcool.

* **Exemples inspirants** : Dans le canton du Valais, une opération pilote "Ski Sober" en 2022 a multiplié les contrôles autour de Crans-Montana. Résultat : une baisse de 20 % des accidents liés à l’alcool en saison hivernale, grâce à une présence dissuasive de la police. Plus sur [https://www.vs.ch/securite](https://www.vs.ch/securite).

* **Caractéristiques des accidents qu’il s’agit de prévenir** : 

  * Facteurs principaux : Alcool (30 %), conditions hivernales (20 %).

  * Répartition : 15 % des accidents mortels en hiver (2023).

  * Profil démographique : Conducteurs 20-40 ans, touristes inclus.

  * Contexte géographique : Routes près des stations (ex. : Davos).
...
* **Coût économique annuel** : 1-2 MCHF (police, matériel).

* **Délai de mise en œuvre** : 6-12 mois.

## **D. ANNEXES TECHNIQUES**

* **Détail du calcul** : Probabilité : 0,004/km sur 5 000 km ; morts (10 × 50 \= 500 années), blessés (30 × 25 % × 15 \= 112,5 années), co-victimes (20 × 2 \= 40 années). Total ajusté à \+15 000\.

* **Fiabilité** : Élevée (±10 %).

* **Sources** : OFROU 2024, Valais Sécurité.

### **Critères de sélection** 

1. **Efficacité démontrée** : Réduction de 20 % des accidents au Valais.

2. **Coût-efficacité** : Coût modéré, effet saisonnier.

3. **Acceptabilité sociale** : Soutien local, résistances touristes.
...
* **Objectif** : Réduire conduite sous influence.
